...
for (i in seq(0,18,1)){
  ...
  all_colinear = rbind(all_colinear,df)
}
all_colinear$clade = factor(all_colinear$clade, levels = c("Iberian", "Muralis", "Siculus", "Sicilian-Maltese", "Western", "Balkan"))
all_colinear$Compared_clade = factor(all_colinear$Compared_clade, levels = c("Iberian", "Muralis", "Siculus", "Sicilian-Maltese", "Western", "Balkan"))
...
single_entries_og = all_colinear[paste0(all_colinear$Focal_genome, "-", all_colinear$Focal_hap, "-", all_colinear$Focal_chr, "-", all_colinear$Chromosome_Window_Start, "-", all_colinear$Chromosome_Window_End) %in%  paste0(single_entries$Focal_genome, "-", single_entries$Focal_hap, "-", single_entries$Focal_chr, "-", single_entries$Chromosome_Window_Start, "-", single_entries$Chromosome_Window_End),]
...
single_clade_og = all_colinear[paste0(all_colinear$Focal_genome, "-", all_colinear$Focal_hap, "-", all_colinear$Focal_chr, "-", all_colinear$Chromosome_Window_Start, "-", all_colinear$Chromosome_Window_End) %in%  paste0(single_clade$Focal_genome, "-", single_clade$Focal_hap, "-", single_clade$Focal_chr, "-", single_clade$Chromosome_Window_Start, "-", single_clade$Chromosome_Window_End),]
...
multiple_entries_og = all_colinear[paste0(all_colinear$Focal_genome, "-", all_colinear$Focal_hap, "-", all_colinear$Focal_chr, "-", all_colinear$Chromosome_Window_Start, "-", all_colinear$Chromosome_Window_End) %in%  paste0(multiple_entries$Focal_genome, "-", multiple_entries$Focal_hap, "-", multiple_entries$Focal_chr, "-", multiple_entries$Chromosome_Window_Start, "-", multiple_entries$Chromosome_Window_End),]
...
all_colinear_modified = rbind(single_entries_og,single_clade_og,choose_mcr_first,choose_same_clade,multiple_entries_og)
all_colinear_modified$queries = paste0(all_colinear_modified$Focal_genome, "#", 
                                          all_colinear_modified$Focal_hap, "#", 
                                          all_colinear_modified$Focal_chr, ":", 
                                          all_colinear_modified$Chromosome_Window_Start, "-", 
                                          all_colinear_modified$Chromosome_Window_End)

##Plot matrix of shared ancestry

p = all_colinear_modified %>% 
...
p1 = all_colinear_modified %>% filter(Focal_genome %in% c("rPodRaf1", "rPodFil1", "rPodTil1", "rPodSic1")) %>% 
...
all_colinear_modified$Chr = sapply(str_split(all_colinear_modified$queries, ":"), .subset,1)
high_SV_regions = all_colinear_modified %>%
  group_by(Chr) %>%
...
for (i in unique(all_colinear_modified$Chr)) {
  
  chr_data = all_colinear_modified[all_colinear_modified$Chr == i, ]
...
rest_of_chr = all_colinear_modified %>%
