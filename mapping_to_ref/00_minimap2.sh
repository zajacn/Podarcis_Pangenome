...
do
 ...
 /data/biosoftware/samtools/samtools-1.20/samtools index $DIR/SYRI/community${k}/community${k}.rPodCre2.1_to_all/$i.sorted.bam
done

##Coverage
for i in $(ls $DIR/SYRI/community${k}/community${k}.rPodCre2.1_to_all/*.bam);
do
